...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() . 'assets/templates/styles/bootstrap4/bootstrap.min.css' ?>">
</head>
...
<body>
    ...
    <script type="text/javascript" src="<?php echo base_url() . 'assets/templates/js/jquery-3.3.1.min.js' ?>"></script>
    <script type="text/javascript" src="<?php echo base_url() . 'assets/templates/styles/bootstrap4/bootstrap.min.js' ?>"></script>
