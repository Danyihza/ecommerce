...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/templates/'); ?>plugins/slick-1.8.0/slick.css">
                                ...
                                <div class="header_search_content">
                                    <div class="header_search_form_container">
                                        <form action="#" class="header_search_form clearfix">
                                            ...
                                            <button type="submit" class="header_search_button trans_300" value="Submit"><img src="<?= base_url('assets/templates/'); ?>images/search.png" alt=""></button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                                ...
                                <div class="cart">
                                    <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                        <div class="cart_icon">
                                            <img src="<?= base_url('assets/templates/'); ?>images/cart.png" alt="">
                        ...
                        <div class="col">
                            ...
                            <div class="main_nav_content d-flex flex-row">
                                ...
                                <div class="cat_menu_container">
                                    ...
                                    <ul class="cat_menu">
                                        <?php foreach($kategori as $k) : ?>
                                        <li><a href="#"><?= $k['nama_kategori']?><i class="fas fa-chevron-right ml-auto"></i></a></li>
                                        <?php endforeach; ?>
