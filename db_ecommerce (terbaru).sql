...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2020 at 09:13 PM
...
(1, 'Nolan W. Murphy', 19, 30000, 0, '', 'foto_cover.jpg', 1, ''),
...
INSERT INTO `ulasan` (`id_ulasan`, `id_produk`, `nama_ulasan`, `isi_ulasan`, `rating_ulasan`) VALUES
(1, 1, 'Dany', 'Bagus sekalii, penggunaan kata dan lainnya sangat tepat, enak dibaca, cover juga bagus, ga nyesel beli', 5),
(2, 1, 'Arin', 'Biasa Aja', 4),
(3, 2, 'Arin', 'suka banget', 5),
(4, 2, 'Dany', 'Lumayan', 3);
